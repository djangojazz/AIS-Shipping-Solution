...
Public Module ShipsCommunications
  Public Function TestLoadShipLocations(increment As Double) As IList(Of ShipModel)
    'Return {
    'MakeABoat(111111111, "Anne Sleuth", ShipType.Owned, 46.851859 - increment, -129.322418 - increment,
    ...
    'MakeABoat(367197230, "Buck & Ann", ShipType.Owned, 46.451859 - increment, -124.322418 - increment,
    '          New List(Of ShipVolume)({
    '                                  New ShipVolume With {.BoatHale = 500, .ExpectedVolume = 2000, .CatchType = CatchType.Shrimp}
    '                                  })),
    'MakeABoat(371321345, "Chrimeney Jeeps", ShipType.Owned, 51.421869 - increment, -135.322418 - increment,
    '          New List(Of ShipVolume)({
